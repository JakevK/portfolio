  ...
  return (
    <>
      <Head>
        <meta
          name="description"
          content="Hi, I'm Jake. I'm a Software Engineering student at the
      ...
      <Layout>
        <>
          ...
          <Paragraph>
            ...
            proficient in several languages, including C++, Python, JavaScript
            and Java.
          </Paragraph>
          <Paragraph>
            In my spare time, I enjoy practicing Competitive Programming. In
            2022, I competed in{" "}
            <a href="https://icpc.global/" target="_blank">
              ICPC
            </a>{" "}
            for the first time and qualified for the South Pacific Regional
            Finals. I had to compete alone due to my teammates having COVID-19,
            so I was quite happy with this result!
          </Paragraph>
          <Paragraph>
            When I&apos;m not writing code, I&apos;m probably out climbing
            rocks. I&apos;m an avid boulderer, and an active member of my
